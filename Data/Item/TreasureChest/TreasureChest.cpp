...
TreasureChest::TreasureChest(int id,int turns_remaining, int row, int col) :
...
std::string TreasureChest::get_description() const {
    return "You've found a treasure overflowing with gold";
}